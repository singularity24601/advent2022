...
q11items <- list()
q11items[[1]] <- c(99, 67, 92, 61, 83, 64, 98)
q11items[[2]] <- c(78, 74, 88, 89, 50)
q11items[[3]] <- c(98, 91)
q11items[[4]] <- c(59, 72, 94, 91, 79, 88, 94, 51)
q11items[[5]] <- c(95, 72, 78)
q11items[[6]] <- c(76)
q11items[[7]] <- c(69, 60, 53, 89, 71, 88)
q11items[[8]] <- c(72, 54, 63, 80)
